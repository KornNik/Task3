...
namespace Assets.UI
{
    public sealed class ScreenInterface : IDisposable
    {
        ...
        public void Execute(ScreenType screenType)
        {
            ...
            switch (screenType)
            {
                ...
                case ScreenType.MainMenu:
                    ...
                    break;
                case ScreenType.PreGameMenu:
                    _currentWindow = _screenFactory.GetPreGameMenu();
                    break;
        ...
        public void AddObserver(ScreenType screenType, IListnerScreen listenerScreen)
        {
            switch (screenType)
            {
                case ScreenType.GameMenu:
                ...
                case ScreenType.MainMenu:
                    ...
                    break;
                case ScreenType.PreGameMenu:
                    _screenFactory.GetPreGameMenu().ShowUI += listenerScreen.ShowScreen;
                    _screenFactory.GetPreGameMenu().HideUI += listenerScreen.HideScreen;
                    _screenFactory.GetPreGameMenu().Hide();
                    break;
        ...
        public void RemoveObserver(ScreenType screenType, IListnerScreen listenerScreen)
        {
            switch (screenType)
            {
                case ScreenType.GameMenu:
